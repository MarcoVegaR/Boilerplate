      ...
      cell: ({ row }) => (
        <div className="flex space-x-2">
          <Button
            size="sm"
            variant="outline"
            onClick={() => router.visit(route('admin.tenants.edit', row.original.id))}
          >
            Edit
          </Button>
          <Button
            ...
            onClick={() => {
              if (confirm('Are you sure you want to delete this item?')) {
                router.delete(route('admin.tenants.destroy', row.original.id));
              }
            }}
          >
            Delete
          ...
          <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div className="p-6 bg-white border-b border-gray-200">
              <div className="flex justify-between items-center mb-6">
                ...
                <Button onClick={() => router.visit(route('admin.tenants.create'))}>
                  Create Tenant
                </Button>
              </div>
              ...
              <DataTable
                ...
                onPaginationChange={({ pageIndex }) => {
                  router.get(
                    route('admin.tenants.index', { page: pageIndex + 1, search }),
                    {},
                    { preserveState: true, replace: true }
                  );
                }}
